...
const EditProfileEducationModal = ({
  id,
  show,
  onHide,
  updateEducation,
  ...
  const [formData, setFormData] = useState({
    degree: userEdu && userEdu.degree,
    college: userEdu && userEdu.college,
    start_date: userEdu && userEdu.start_date,
    end_date: userEdu && userEdu.end_date,
  })
  ...
  const onSubmit = (e) => {
    ...
    updateEducation(id, user.id, degree, college, start_date, end_date)
    onHide(true)
    setValidated(true)
  }
