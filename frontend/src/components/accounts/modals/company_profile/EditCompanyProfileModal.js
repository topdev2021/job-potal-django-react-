...
const EditCompanyProfileModal = ({
  ...
  useEffect(() => {
    if (show) {
      getSingleCompanyProfile(id)
    }
  }, [getSingleCompanyProfile, id])
  const [validated, setValidated] = useState(false)
  const [formData, setFormData] = useState({
    name: companyProfile && companyProfile.name,
    about: companyProfile && companyProfile.about,
    phone: companyProfile && companyProfile.phone,
    address: companyProfile && companyProfile.address,
    website: companyProfile && companyProfile.website,
    linkedin_link: companyProfile && companyProfile.linkedin_link,
    twitter_link: companyProfile && companyProfile.twitter_link,
  })
