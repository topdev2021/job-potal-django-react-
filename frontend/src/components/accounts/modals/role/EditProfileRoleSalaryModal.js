...
import { getSingleRole, updateRole } from '../../../../actions/profile'

const EditProfileRoleSalaryModal = ({
  id,
  show,
  onHide,
  getSingleRole,
  ...
  const [formData, setFormData] = useState({
    preferred_role: userRole && userRole.preferred_role,
    current_salary: userRole && userRole.current_salary,
  })
  ...
  const onSubmit = (e) => {
    ...
    updateRole(id, user.id, preferred_role, current_salary)
    onHide(true)
    setValidated(true)
  }
  ...
  return (
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title>Update Role and current salary</Modal.Title>
      </Modal.Header>
...
export default connect(mapStateToProps, { getSingleRole, updateRole })(
